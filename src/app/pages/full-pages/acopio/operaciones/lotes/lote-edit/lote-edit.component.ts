...
export class LoteEditComponent implements OnInit {
  ...
  Print(): void {
    ...
    const lista = [
      {
        Numero: 'L00000014',
        SocioId: 14,
        CodigoSocio: 'JSA00000011',
        AgenciaCertificadora: 'Ceres|Otra',
        Socio: 'Ruiz Carlos Antonio',
        Zona: 'SAN JUAN CENTRO AUTIKI  ',
        Finca: 'La Esperanza II',
        Cantidad: 14,
        TotalKilosBrutosPesado: 1738,
        PromedioTotalAnalisisSensorial: 80.61,
        PromedioRendimientoPorcentaje: 83.61,
        PromedioHumedadPorcentaje: 13.19,
        TipoProduccion: 'Organico',
        Certificacion: 'FAIR TRADE|NATURALAND'
      },
      {
        Numero: 'L00000014',
        SocioId: 14,
        ...
        Numero: 'L00000014',
        SocioId: 15,
        CodigoSocio: 'JSA00000012',
        AgenciaCertificadora: 'Ceres|Otra',
        Socio: 'Pariasca Dennis',
        Zona: 'ZONA 1',
        Finca: 'La Esperanza',
        Cantidad: 2,
        TotalKilosBrutosPesado: 1738,
    ...
    html2canvas(div2, { allowTaint: true, scale: 1 }).then(function (canvas) {
